...
ConfName=Release
ImagePath="dist\Release\${IMAGE_TYPE}\Unit.${IMAGE_TYPE}.${OUTPUT_SUFFIX}"
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-Release.mk dist/${CND_CONF}/${IMAGE_TYPE}/Unit.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
	@echo "--------------------------------------"
	@echo "User defined post-build step: [if ${IsDebug} == "false" ${ProjectDir}\flash_hex.cmd ${Device} ${ImagePath}]"
	@if ${IsDebug} == "false" ${ProjectDir}\flash_hex.cmd ${Device} ${ImagePath}
	@echo "--------------------------------------"
...
${OBJECTDIR}/display/MM5481N.asm.o: display/MM5481N.asm.S  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/display/MM5481N.asm.o.ok ${OBJECTDIR}/display/MM5481N.asm.o.err 
	 ${MP_CC} $(MP_EXTRA_AS_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS}  -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -x assembler-with-cpp -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -MD -MP -MF "${OBJECTDIR}/display/MM5481N.asm.o.d" -MT "${OBJECTDIR}/display/MM5481N.asm.o.d" -MT ${OBJECTDIR}/display/MM5481N.asm.o -o ${OBJECTDIR}/display/MM5481N.asm.o display/MM5481N.asm.S  -DXPRJ_Release=$(CND_CONF)  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/display/MM5481N.asm.o.asm.d",--defsym=__MPLAB_DEBUG=1,--gdwarf-2,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1
...
${OBJECTDIR}/display/PCF2112CT.asm.o: display/PCF2112CT.asm.S  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/display/PCF2112CT.asm.o.ok ${OBJECTDIR}/display/PCF2112CT.asm.o.err 
	 ${MP_CC} $(MP_EXTRA_AS_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS}  -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -x assembler-with-cpp -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -MD -MP -MF "${OBJECTDIR}/display/PCF2112CT.asm.o.d" -MT "${OBJECTDIR}/display/PCF2112CT.asm.o.d" -MT ${OBJECTDIR}/display/PCF2112CT.asm.o -o ${OBJECTDIR}/display/PCF2112CT.asm.o display/PCF2112CT.asm.S  -DXPRJ_Release=$(CND_CONF)  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/display/PCF2112CT.asm.o.asm.d",--defsym=__MPLAB_DEBUG=1,--gdwarf-2,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1
...
${OBJECTDIR}/actuators/airDistMotor.o: actuators/airDistMotor.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/actuators/airDistMotor.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/actuators/airDistMotor.o.d" -MT "${OBJECTDIR}/actuators/airDistMotor.o.d" -MT ${OBJECTDIR}/actuators/airDistMotor.o  -o ${OBJECTDIR}/actuators/airDistMotor.o actuators/airDistMotor.c  -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/actuators/elecSpeedReg.o: actuators/elecSpeedReg.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/actuators/elecSpeedReg.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/actuators/elecSpeedReg.o.d" -MT "${OBJECTDIR}/actuators/elecSpeedReg.o.d" -MT ${OBJECTDIR}/actuators/elecSpeedReg.o  -o ${OBJECTDIR}/actuators/elecSpeedReg.o actuators/elecSpeedReg.c  -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/actuators/lamps.o: actuators/lamps.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/actuators/lamps.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/actuators/lamps.o.d" -MT "${OBJECTDIR}/actuators/lamps.o.d" -MT ${OBJECTDIR}/actuators/lamps.o  -o ${OBJECTDIR}/actuators/lamps.o actuators/lamps.c  -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/actuators/threeLevelSwitch.o: actuators/threeLevelSwitch.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/actuators/threeLevelSwitch.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/actuators/threeLevelSwitch.o.d" -MT "${OBJECTDIR}/actuators/threeLevelSwitch.o.d" -MT ${OBJECTDIR}/actuators/threeLevelSwitch.o  -o ${OBJECTDIR}/actuators/threeLevelSwitch.o actuators/threeLevelSwitch.c  -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/comms/usart.o: comms/usart.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/comms/usart.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/comms/usart.o.d" -MT "${OBJECTDIR}/comms/usart.o.d" -MT ${OBJECTDIR}/comms/usart.o  -o ${OBJECTDIR}/comms/usart.o comms/usart.c  -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/display/led.o: display/led.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/display/led.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/display/led.o.d" -MT "${OBJECTDIR}/display/led.o.d" -MT ${OBJECTDIR}/display/led.o  -o ${OBJECTDIR}/display/led.o display/led.c  -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/EEPROM/EEPROM_data.o: EEPROM/EEPROM_data.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/EEPROM/EEPROM_data.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/EEPROM/EEPROM_data.o.d" -MT "${OBJECTDIR}/EEPROM/EEPROM_data.o.d" -MT ${OBJECTDIR}/EEPROM/EEPROM_data.o  -o ${OBJECTDIR}/EEPROM/EEPROM_data.o EEPROM/EEPROM_data.c  -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/keypad/keypad.o: keypad/keypad.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/keypad/keypad.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/keypad/keypad.o.d" -MT "${OBJECTDIR}/keypad/keypad.o.d" -MT ${OBJECTDIR}/keypad/keypad.o  -o ${OBJECTDIR}/keypad/keypad.o keypad/keypad.c  -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/rtos/tasks.o: rtos/tasks.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/rtos/tasks.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/rtos/tasks.o.d" -MT "${OBJECTDIR}/rtos/tasks.o.d" -MT ${OBJECTDIR}/rtos/tasks.o  -o ${OBJECTDIR}/rtos/tasks.o rtos/tasks.c  -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/rtos/timers.o: rtos/timers.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/rtos/timers.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/rtos/timers.o.d" -MT "${OBJECTDIR}/rtos/timers.o.d" -MT ${OBJECTDIR}/rtos/timers.o  -o ${OBJECTDIR}/rtos/timers.o rtos/timers.c  -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/ElectronicACUnitAVR8.o: ElectronicACUnitAVR8.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/ElectronicACUnitAVR8.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/ElectronicACUnitAVR8.o.d" -MT "${OBJECTDIR}/ElectronicACUnitAVR8.o.d" -MT ${OBJECTDIR}/ElectronicACUnitAVR8.o  -o ${OBJECTDIR}/ElectronicACUnitAVR8.o ElectronicACUnitAVR8.c  -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/actuators/airDistMotor.o: actuators/airDistMotor.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/actuators/airDistMotor.o.d 
	@${RM} ${OBJECTDIR}/actuators/airDistMotor.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega324pa ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS}  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -I"." -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -Wall -MD -MP -MF "${OBJECTDIR}/actuators/airDistMotor.o.d" -MT "${OBJECTDIR}/actuators/airDistMotor.o.d" -MT ${OBJECTDIR}/actuators/airDistMotor.o  -o ${OBJECTDIR}/actuators/airDistMotor.o actuators/airDistMotor.c  -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD) 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Unit.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) -mmcu=atmega324pa ${PACK_COMMON_OPTIONS}  -D__MPLAB_DEBUGGER_SIMULATOR=1 -gdwarf-2 -D__$(MP_PROCESSOR_OPTION)__  -Wl,-Map="dist\${CND_CONF}\${IMAGE_TYPE}\Unit.${IMAGE_TYPE}.map"    -o dist/${CND_CONF}/${IMAGE_TYPE}/Unit.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}      -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1 -Wl,--gc-sections -Wl,--start-group  -Wl,-lm -Wl,--end-group 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Unit.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mmcu=atmega324pa ${PACK_COMMON_OPTIONS}  -D__$(MP_PROCESSOR_OPTION)__  -Wl,-Map="dist\${CND_CONF}\${IMAGE_TYPE}\Unit.${IMAGE_TYPE}.map"    -o dist/${CND_CONF}/${IMAGE_TYPE}/Unit.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}      -DXPRJ_Release=$(CND_CONF)  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION) -Wl,--gc-sections -Wl,--start-group  -Wl,-lm -Wl,--end-group 
