...
/* ***
   ...
   RETURN: void
*** */
void EEPROMRead_block(const void * address, void * block, size_t size) {
   eeprom_read_block(block, address, size);
}
...
/* ***
   ...
   RETURN: void
*** */
void EEPROMWrite_block(const void * address, void * block, size_t size) {
   eeprom_update_block(address, block, size);
}
